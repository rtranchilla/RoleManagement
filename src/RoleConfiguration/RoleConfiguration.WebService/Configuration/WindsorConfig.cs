...
{
    public static void ConfigureRoleManagerRepositories(this IServiceCollection container)
    {
    ...
    public static void ConfigureYamlSerialization(this IServiceCollection container)
    {
        container.AddSingleton<Serializer>();
        container.AddSingleton<Deserializer>();
    }

    public static void ConfigureRoleManagerHttpClient(this IServiceCollection container)
    {
        container.AddSingleton(new HttpClient
        {
            BaseAddress = new Uri(container.GetRequiredService<IConfiguration>()["RoleManagerUrl"])
        });
    }

    public static void UpdateDatabase(this IServiceProvider container)
    {
        using var context = container.GetRequiredService<ConfigDbContext>();
        context.Database.Migrate();
    }

    public static void ConfigureJsonSettings(this IServiceCollection container) => 
        container.AddSingleton<JsonSerializerSettings>();
